...
# +
cloudmasked_rhos_555 = cloudmasked_dataset["rhos"].sel({"wavelength_3d": np.argwhere(wavelengths == 555)[0][0]})
...
masked_rhos_555 = masked_dataset["rhos"].sel({"wavelength_3d": np.argwhere(wavelengths == 555)[0][0]})
