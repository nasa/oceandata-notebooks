...
or by downloading the notebook files by clicking the download icon in the upper right corner of the page and selecting ".ipynb", and running them with [JupyterLab][jupyterlab].
