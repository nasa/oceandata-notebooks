...
:::{dropdown} How can I access PACE data?
...
:::{dropdown} What's the best way to browse and download PACE images using SeaDAS?
...
:::{dropdown} Where can I learn more about the PACE mission and its instruments?
...
:::{dropdown} Is it possible to download a single product from PACE Level 3 files, instead of downloading the full product suite (e.g., IOP, AOP, BGC)?
...
:::{dropdown} I keep hearing about Harmony for subsetting PACE data, what does it do, and how do I access it?
...
:::{dropdown} Is subsetting really worth it, or should I just download the full files?
...
:::{dropdown} Harmony-Py doesn't seem to support subsetting for Level 3 data, is there another way to do this?
...
:::{dropdown} Is Harmony planned to support Level 3 data, or will that remain limited to Xarray-based workflows?
...
:::{dropdown} When subsetting Level 2 data in SeaDAS, why do I lose quality flags if I select individual variables?
...
:::{dropdown} I'm trying to clip a smaller region from PACE data using the Level 3/Level 4 browser's "extract" tool, but I'm not getting all the bands I expect. Is this a known issue?
...
:::{dropdown} What is the difference between PACE Level 1B and Level 1C files?
...
:::{dropdown} Do I need to download both HARP2 Level 1C and Level 2 data instead of just Level 2?
...
:::{dropdown} Is there a workflow for bringing PACE OCI data into Google Earth Engine?
...
:::{dropdown} Why is PACE OCI surface reflectance data in 32-bit float format, while remote sensing reflectance (Rrs) data is in 16-bit format?
...
:::{dropdown} Why does it sometimes take a long time for PACE OCI refined (non-near-real-time) monthly and 8-day products to become available?
...
:::{dropdown} Are there any plans to generate 8-day or monthly composites directly from near-real-time daily data, to reduce the wait for refined products?
...
:::{dropdown} What does "cloud computing" mean in the context of NASA's Earth Data Cloud?
...
:::{dropdown} Where can I learn the basics of cloud computing and working with Earth Data Cloud?
...
:::{dropdown} What are my options if I want to get into a cloud computing environment to work with PACE data?
...
:::{dropdown} Does it cost money to access and analyze PACE data in the cloud?
...
:::{dropdown} When I run a local Python script using my Earthdata credentials (e.g., with earthaccess) to search and access cloud data, is the data being downloaded to my computer, or is my code running in the cloud?
...
:::{dropdown} Can I run L2gen remotely from my local computer using cloud-hosted PACE data?
...
:::{dropdown} Is there a way to run L2gen-based processing without setting up my own cloud compute environment?
...
:::{dropdown} How are atmospheric artifacts and scan-edge errors handled in OCI data?
...
:::{dropdown} How does PACE distinguish aerosols from harmful algal blooms (HABs)?
...
:::{dropdown} Can users adjust processing settings for turbid or inland waters (e.g., lakes)?
...
:::{dropdown} What are the main differences between the aerosol products from PACE's three sensors (OCI, HARP2, SPEXone)?
...
:::{dropdown} Are there aerosol-related products in the Ocean Color (AOP) product suite as well?
...
:::{dropdown} Is there a common approach for applying custom atmospheric correction algorithms (such as Polymer) to PACE data?
...
:::{dropdown} What are the main differences between the cloud products from OCI, HARP2, and SPEXone?
...
:::{dropdown} Why are traditional statistical/empirical algorithms used for PACE OCI chlorophyll detection instead of machine learning techniques?
...
:::{dropdown} Can PACE data (including pigment data) distinguish between species or only genus/class? Can in situ pigment data help validate or distinguish species?
...
:::{dropdown} Are there plans to use backscatter/scattering data for genus- or species-level phytoplankton identification?
...
:::{dropdown} Is it possible to obtain the phytoplankton absorption coefficient (aph) using PACE, and is it applicable to coastal/estuary studies?
...
:::{dropdown} How large does a lake need to be for a harmful algal bloom to be observable/detectable with PACE OCI?
...
:::{dropdown} What are the advantages of PACE's NO2 product compared to TROPOMI and TEMPO?
...
:::{dropdown} How do EMIT and PACE complement each other?
...
:::{dropdown} Is there a tutorial or notebook series demonstrating how to use PACE and EMIT data together?
...
:::{dropdown} Are there bands that PACE OCI is missing that would be useful for fire-related applications, compared to EMIT?
...
:::{dropdown} Is there a difference in the number of overlapping observations between EMIT and PACE across the northern versus southern hemisphere?
...
:::{dropdown} How do EarthCare and PACE complement each other?
...
:::{dropdown} Is there a tool to help find and compare matching PACE and EarthCare observations?
...
:::{dropdown} Will the proposed GLIMR mission have better shortwave bands than PACE OCI?
...
:::{dropdown} What are the best practices for using PACE data in machine learning applications?
