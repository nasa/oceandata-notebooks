...
Access recordings, materials, and resources from past NASA ocean color training events, workshops, and webinars. These comprehensive training resources provide coverage of ocean color science, PACE mission data products, data processing techniques, and analysis methods. The events range from intensive hackweeks and hands-on workshops to lecture series and specialized training programs, offering learning opportunities for users at all levels&mdashfrom beginners getting started with ocean color data to experienced researchers looking to expand their knowledge of specific instruments, algorithms, and applications. Browse the full list to access comprehensive learning materials from past events and expand your ocean color data analysis skills.

- [Fish-PACE Hackweek 2026](https://fish-pace.github.io/hackweek-2025) - The NOAA led Fish-PACE hackweek with presentations, notebooks, and hands-on PACE data tutorials.
- [PACE Data Hackweek 2025](https://pacehackweek.github.io/pace-2025/presentations/notebooks.html) - Latest hackweek with presentations, notebooks, and hands-on PACE data tutorials
...
- [PACE Hackweek 2024](https://pacehackweek.github.io/pace-2024/intro.html) - Previous hackweek materials and collaborative learning resources
