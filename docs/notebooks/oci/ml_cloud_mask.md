...
**NOTE**: This notebook will download a [cloud mask dataset](https://oceandata.sci.gsfc.nasa.gov/fileshare/ian_carroll/pace-hackweek/). Update `CLDMASK_PATH` if you would like the download and extracted archive to be persisted after running this notebook.
...
if CLDMASK_PATH is None or not CLDMASK_PATH.exists():
    ...
    with tempfile.TemporaryFile() as f:
        url = "https://oceandata.sci.gsfc.nasa.gov/fileshare/ian_carroll/pace-hackweek/cldmask_dataset.tar.gz"
