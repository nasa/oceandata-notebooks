...
Here is an example of comparing input `chlor_a` (derived mechanistically from NOBM) to output `chlor_a` derived from NASA OB.DAAC ([Chl a ATBD](https://oceandata.sci.gsfc.nasa.gov/files/atbd/atbd-obdaac-chlorophyll-a.pdf)).
